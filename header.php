...
<header class="navbar navbar-expand navbar-dark bg-dark flex-column flex-md-row bd-navbar">
  <a class="navbar-brand mr-0 mr-md-2" href="/senate/adminpage.php" aria-label="Bootstrap">
  ...
  <div class="navbar-nav-scroll">
    <ul class="navbar-nav bd-navbar-nav flex-row">
      ...
      <li class="nav-item">
        <a class="nav-link " href="addmembers.php">Add Senate Members</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="memberlist.php">Senate Members List</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="meeting.php">Schedule Meeting</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="agenda.php">Add Agenda</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="postpone.php">Postpone Meeting</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="minutes.php">Upload minutes</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="meetingslist.php">Meetings List</a>
      </li>
      <li class="nav-item">
